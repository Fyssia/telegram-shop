...
const COPY: Record<Locale, RefundsCopy> = {
  ...
  ru: {
    metaTitle: "Возвраты",
    metaDescription:
      "Политика возвратов для покупок Telegram Stars и неуспешных доставок.",
    kicker: "Документы",
    title: "Политика возвратов",
    subtitle:
      "Возвраты рассматриваются по статусу оплаты и доставки. В каждом обращении указывайте request ID.",
    updatedAt: "Обновлено: 5 марта 2026",
    sections: [
      {
        title: "1. Когда возможен возврат",
        list: [
          "Заказ завершился ошибкой и Stars не были доставлены.",
          "Оплата прошла, но статус не был урегулирован в пределах SLA поддержки.",
      ...
      },
      {
        ...
        list: [
          ...
          "Неверный получатель, введенный пользователем.",
      ...
      },
      {
        ...
        list: [
          "Напишите в поддержку и укажите request ID.",
      ...
      },
      {
        ...
        body: "Каждый запрос проверяется вручную по платежным и delivery-логам. Срок ответа зависит от окна подтверждения платежного провайдера.",
      },
      {
        title: "5. Важно",
        body: "Чтобы снизить риск ошибки, всегда проверяйте @username в checkout перед оплатой.",
      },
    ],
  },
};
